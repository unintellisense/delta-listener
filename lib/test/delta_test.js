...
describe("DeltaContainer", function () {
    ...
    it('should listen for changes on parent objects', function (done) {
        ...
        chai_1.assert.equal(assertCount, 4);
        done();
    });
    ...
    it('should listen for changes on parent objects and trigger on new properties', function (done) {
        var assertCount = 0;
        var cloned = clone(data);
        container.listen("entities/:name", "replace", function (player, value) {
            assertCount++;
        ...
        container.set(cloned);
        chai_1.assert.equal(assertCount, 0);
        cloned = clone(data);
    ...
    it('should listen for changes on parent objects and trigger on deleted properties', function (done) {
        var assertCount = 0;
        var cloned = clone(data);
        container.listen("entities/:name", "replace", function (player, value) {
            assertCount++;
